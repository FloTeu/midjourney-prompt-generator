...
from mid_prompt_gen.backend.data_classes import FewShotGenerationMessages
...
class AbstractTextToImagePromptGenerator(AbstractFewShotGenerator):
    ...
    def _set_human_message(self):
        ...
        human_template = """
                            ...
                            Write a single prompt for the text delimited by ```. 
                            ...
                            Remember to format the prompts semantically similarly to the example prompts. 
